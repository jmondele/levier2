...
export default function Footer() {
  return (
    <footer className="bg-[#0A0B0A] text-[#EFE7D2] border-t border-[rgba(239,231,210,0.15)]">
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-[rgba(239,231,210,0.15)] flex flex-col md:flex-row justify-between items-center gap-4">
