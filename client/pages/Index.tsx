          ...
          <div className="relative z-10 flex flex-col h-full min-h-[600px] lg:min-h-[800px]">
            ...
            <nav className="m-4 md:m-12 inline-flex items-center gap-2 md:gap-3 p-2 rounded-xl bg-[#0A0B0A] w-fit max-w-full">
              ...
              <div className="hidden md:flex items-center gap-1 flex-shrink-0">
                <button className="px-3 py-3 rounded-lg text-[#E0D3C4] font-galliso text-xs font-normal leading-[130%] tracking-[1px] uppercase hover:bg-[rgba(24,24,24,0.3)] transition-colors">
                  Menu
                </button>
                <button className="px-3 py-3 rounded-lg text-[#E0D3C4] font-galliso text-xs font-normal leading-[130%] tracking-[1px] uppercase hover:bg-[rgba(24,24,24,0.3)] transition-colors">
                  About
                </button>
                <button className="px-3 py-3 rounded-lg border border-[rgba(239,231,210,0.15)] bg-[rgba(24,24,24,0.5)] text-[#E0D3C4] font-galliso text-xs font-normal leading-[130%] tracking-[1px] uppercase hover:bg-[rgba(24,24,24,0.7)] transition-colors">
                  Book a Table
                </button>
              </div>
            </nav>
